...
const COURSES_VIEW_FEEDBACK = (id: string) =>
  `${COURSES_URL}/view_feedback/${id}`;
...
const QUALITY_IMPROVEMENT_VIEW_FEEDBACK_URL = (id: string) =>
  `${QUALITY_IMPROVEMENTS_URL}/view_feedback/${id}`;
...
const RESEARCH_REQUIRED_BY_ID_URL: (id: string) => string = (id: string) =>
  `${RESEARCH_REQUIRED_URL}/${id}`;
const RESEARCH_VIEW_FEEDBACK: (id: string) => string = (id: string) =>
  `${RESEARCH_REQUIRED_URL}/viewFeedback/${id}`;
